...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/01.png?raw=true )

Siguiendo todas las instrucciones, cargaría como en la imagen de abajo. 

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/02.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/03.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/04.png?raw=true )

Una vez instalado y ejecutándose correctamente, vamos a probar las conexiones, y se realizara con el comando Ifconfig eht0

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/05.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/06.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/07.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/08.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/09.png?raw=true )
  
Ahora se procedera con escaneo detallado. Sera un escaneo exhaustivo para identificar puertos abiertos, servicios que se ejecutan y vulnerabilidades basicas. Usamos nmap -sV -sC -p- -T4 -oN nmap_scan_metasploitable2.txt 192.168.1.host

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/10.png?raw=true )
   
Una vez terminado el escaneo, iremos a la carpeta para tomar el archivo .txt donde esta la informacion encontrada.
 
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/11.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/12.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/13.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/14.png?raw=true )
   
Configuramos el RHOSTS con la ruta del host victima

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/15.png?raw=true )
   
Realizamos el exploit, si es correcto. Tendremos los privilegios y accederemos

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/16.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/17.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/18.png?raw=true )
 
 
Se realiza el use exploit y show options para configurar las opciones para la prueba.

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/19.png?raw=true )
 
 
Se configura el host de la victima con set RHOSTS

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/21.png?raw=true )
 
Para esta prueba funciono con reverse_netcad  
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/22.png?raw=true ) 

Comando shows options 

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/23.png?raw=true )
 
Se configura el Lhost

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/24.png?raw=true )
 
Y se configura el puerto con LPORT

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/25.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/26.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/27.png?raw=true )
 
Ver la version de sistema

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/28.png?raw=true )
 
Con el comando ifconfig –a veremos todas las interfaces de red. 
 
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/29.png?raw=true )


Ahora veremos en detalle cuales son los puertos abiertos y servicios que estan escuchando

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/30.png?raw=true )

Y la tabla de enrutamiento mediante el comando route -n

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/31.png?raw=true )
 
Se observan la lista de usuario con el comando cat /etc/passwd   

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/32.png?raw=true )


Ahora las contraseña que tienen hash cat /etc/shadow      

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/33.png?raw=true )
 
Para ver los grupos del sistema se usa el comando cat /etc/group

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/34.png?raw=true )
 
Podemos ver los procesos en ejecucion con detalles mediante el comando ps aux.

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/36.png?raw=true )
 
Podemos navegar y conocer el contenido del directorio raiz.
 
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/37.png?raw=true )

Podemos realizar mas detalle de informacion sensible como por ejemplo ver informacion de servidores web con /var/www 
 

![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/38.png?raw=true )
...
![image alt](https://github.com/pipetz5303/Laboratorio1/blob/main/39.png?raw=true )
